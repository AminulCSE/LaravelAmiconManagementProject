            ...
            <div class="card card-default col-xs-1 center-block">
              ...
              <form action="{{ URL::to('update_order/'.$data->id) }}" method="POST" enctype="multipart/form-data" class="form-row m-3">
                ...
                <div class="card-body col-md-6">
                  ...
                  <input type="hidden" name="order_month" value="{{ $data->order_month }}">
                  <input type="hidden" name="order_year" value="{{ $data->order_year }}">

                  <div class="form-group">
                    <label for="exampleInputDescription">Order Description</label>
                    <textarea rows="6" class="form-control" name="name" id="exampleInputDescription">{{ $data->name }}</textarea>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="price" id="orderUnitPrice" value="{{ $data->price }}">
                  </div>
                </div>
                ...
                <div class="card-body col-md-6">
                  ...
                  <p style="font-size: 22px;"><strong class="text-success">Total: </strong> <span class="text-primary">{{ $total = ($data->price*$data->quantity) }}</span> Tk
                  </p>
