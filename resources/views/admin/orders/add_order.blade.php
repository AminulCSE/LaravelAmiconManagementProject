              ...
              <form action="{{ URL::to('store_order') }}" method="POST" class="form-row m-3" enctype="multipart/form-data">
                ...
                <div class="card-body col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <select id="exampleInputCustomerName" name="id"  class="form-control select2 select2-danger select2-hidden-accessible" data-dropdown-css-class="select2-danger" style="width: 100%;" data-select2-id="12" tabindex="-1" aria-hidden="true">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="qty" id="OrderQuantity" placeholder="Quantity Ex: 1,2...">
                  </div>
                </div>
                ...
                <div class="card-body col-md-6">
                  <div class="form-group">
                    ...
                    <input onchange="summation()" type="number" class="form-control" name="price" id="orderUnitPrice" placeholder="Unit Price Ex: 1,2...">
                  </div>
  ...
  <table id="example1" class="table table-bordered table-striped">
    ...
    <?php $i++; ?>
        <tr>
          ...
          <td>{{ $val->price }}</td>
          <td>{{ $val->weight }}</td>
          <td>{{ $val->options->order_description }}</td>
          <td>
            <a href="{{ URL::to('edit_order/'.$val->rowId) }}" style="padding: 4px;">
              <i class="fas fa-edit"></i>
            </a>

            <a onclick="return confirm('Are your sure to delete this???')" href="{{ URL::to('delete_order/'.$val->rowId) }}" style="padding: 4px;">
