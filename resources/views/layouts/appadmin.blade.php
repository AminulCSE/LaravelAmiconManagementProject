...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block bg-primary">
    ...
    <!-- Right navbar links -->
    <ul class="navbar-nav ml-auto dropdown show">
      ...
      <li class="nav-item dropdown" >
        <a class="nav-link dropdown-toggle" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">
          <img src="{{ asset('admin/dist/img/user1-128x128.jpg') }}" alt="User Avatar" class="img-size-50 img-circle" style="width: 34px;margin: auto;top: 0px;position: absolute;margin-left: -12px;">
        </a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('/') }}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Amicon Plus</span>
    </a>
...
@yield('content')
 ...
 <!-- Control Sidebar -->
  ...
  <footer class="main-footer">
    <strong>&copy;<a href="#">Amincul islam peal</a>.</strong>
    All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
